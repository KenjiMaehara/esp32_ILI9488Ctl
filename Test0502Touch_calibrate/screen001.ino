...
uint16_t keyColor_screen001[15] = {TFT_RED, TFT_DARKGREY, TFT_DARKGREEN,
...
void drawKeypadScreen001()
{
  ...
  for (uint8_t row = 0; row < 2; row++) {
    for (uint8_t col = 0; col < 1; col++) {
      ...
      key[b].initButton(&tft, KEY_X + col * (KEY_W_screen001 + KEY_SPACING_X_screen001),
